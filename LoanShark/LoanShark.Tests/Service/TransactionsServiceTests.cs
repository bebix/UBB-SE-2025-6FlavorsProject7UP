...
namespace LoanShark.Tests.Service
{
    public class TransactionsServiceTests
    {
        ...
        [Fact]
        public async Task AddTransaction_ShouldFail_WhenReceiverBlocked()
        {
            var sender = new BankAccount("IBAN1", "USD", 1000m, false, 1, "Main", 2000m, 500m, 10);
            var receiver = new BankAccount("IBAN2", "USD", 300m, true, 2, "Savings", 2000m, 500m, 10);
            ...
            Assert.Equal("Receiver account is blocked.", result);
        }

        [Fact]
        public async Task AddTransaction_ShouldFail_WhenSenderDoesntExist()
        {
            ...
            Assert.Equal("Sender account does not exist.", result);
        }

        [Fact]
        public async Task AddTransaction_ShouldFail_WhenReceiverDoesntExist()
        {
            var sender = new BankAccount("IBAN1", "USD", 1000m, false, 1, "Main", 2000m, 500m, 10);
            ...
            Assert.Equal("Receiver account does not exist.", result);
        }
